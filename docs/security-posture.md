...
| Terraform and change control | Moderate | Formatting, validation, speculative plan, modular IaC, Git history, PR-based workflows. | Move from local state to a private Azure Storage backend with state locking, restricted RBAC, versioning, and recovery procedures. Add IaC security scanning. |
